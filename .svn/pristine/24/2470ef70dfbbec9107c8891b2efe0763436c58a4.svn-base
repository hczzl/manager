...
public class ActModelController extends BaseController
{
    ...
    @ResponseBody
    public void save(@PathVariable String modelId, String name, String description, String jsonXml,
            String svgXml) throws IOException
    {
        ...
        model.setName(name);
        actModelService.update(model, jsonXml, svgXml);
