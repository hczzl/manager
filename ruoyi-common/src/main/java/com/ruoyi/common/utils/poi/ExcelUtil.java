...
public class ExcelUtil<T>
{
    ...
    public AjaxResult exportExcel()
    {
        ...
        try
        {
            ...
            String filename = "";
            if("登录日志".equals(sheetName)||"操作日志".equals(sheetName)){
                SimpleDateFormat format=new SimpleDateFormat("yyyyMMddHHmmss");
                filename=sheetName+format.format(new Date())+""+".xlsx";
            }else {
     ...
     * 编码文件名
     */
    static public String encodingFilename(String filename)
    {
     ...
     * @param filename 文件名称
     */
    static public String getAbsoluteFile(String filename)
    {
