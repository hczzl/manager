...
public class SysOperLog extends BaseEntity {
    ...
    public void setBeTime(Long beTime) {
        this.beTime = beTime;
    }
    ...
    public String getBeOperObject() {
        return beOperObject;
    }

    public void setBeOperObject(String beOperObject) {
        this.beOperObject = beOperObject;
    }
