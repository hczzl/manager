...
import com.ruoyi.framework.shiro.web.filter.oauth2.OAuth2Filter;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager) {
        ...
        filterChainDefinitionMap.put("/dologinWxId", "anon");
        filterChainDefinitionMap.put("/dologinPhone", "anon");
        ...
        // 在执行其他的方法的时候，加上拦截token这个条件
        filterChainDefinitionMap.put("/**", "onlineSession,syncOnlineSession,oauth2");
        // 系统权限列表
